<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login', [], false) }}" class="auth-form">
        ...
        <div class="auth-field">
            ...
            <input id="email" class="auth-input" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" inputmode="email" spellcheck="false" autocapitalize="none" data-normalize-email>
